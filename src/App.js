...
function App() {
  ...
  const handleChangeUppercase = () => {
    setPasswordGen({
      ...passwordGen, uppercase: !passwordGen.uppercase
    })
  }
  const handleChangeLowercase = () => {
    setPasswordGen({
      ...passwordGen, lowercase: !passwordGen.lowercase
    })
  }
  const handleChangeNumbers = () => {
    setPasswordGen({
      ...passwordGen, numbers: !passwordGen.numbers
    })
  }
  const handleChangeSymbols = () => {
    setPasswordGen({
      ...passwordGen, symbols: !passwordGen.symbols
    })
  }
  const setPasswordLength = (val) => {
    setPasswordGen({
      ...passwordGen, length: val
    })
  }
        ...
        <div className="word-crieteria__box">
          ...
          <div>
            <input
              ...
              min="4"
              max="20"
              value={passwordGen.length} onChange={(e) => setPasswordLength(e.target.value)}
            />
          </div>
        </div>
        <div className="word-crieteria__box">
